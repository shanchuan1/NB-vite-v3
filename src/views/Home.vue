<template>
    <div>
        ...
        <!-- 商品分类 -->
        <GoodList :goodsArr="newGoodses" :title="'新品上线'" />
        <GoodList :goodsArr="hots" :title="'热门商品'" />
        <GoodList :goodsArr="recommends" :title="'最新推荐'" :style="{ paddingBottom: '100px' }" />
...
import { getHome } from '@/request/api'
